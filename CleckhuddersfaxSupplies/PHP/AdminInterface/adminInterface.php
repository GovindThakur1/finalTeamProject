    ...
    <div class="main-container">
        ...
        <section class="admin-interface" id="admin-interface">
            <div class="container" id="content-container">
                ...
                <div class="boxx" style="background-image: url('../Image/report.jpg');" onclick="navigateTo('http://127.0.0.1:8080/apex/f?p=100:LOGIN_DESKTOP:6267694608686:::::')">
                    <h3>Reports</h3>
                </div>
                <div class="boxx" style="background-image: url('../Image/Dashboard.jpeg');" onclick="navigateTo('http://127.0.0.1:8080/apex/f?p=100:LOGIN_DESKTOP:6267694608686:::::')">
